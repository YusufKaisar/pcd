...
def index():
    ...
    if request.method == 'POST':
        ...
        sharpened = convolve2d(lucy_scaled, high_pass_kernel, mode='same', boundary='symm')
        ...
        blurred_final = convolve2d(sharpened_clipped, gaussian_kernel, mode='same', boundary='symm')
